...
kable(head(Gaji_bulanan, 10), caption = "Tinjauan 10 baris pertama data Gaji_bulanan")
...
corrplot(cor_matrix, 
         ...
         order = "hclust",     # urutkan berdasarkan kemiripan korelasi
         tl.col = "black",     # warna teks label
         tl.cex = 0.8,         # ukuran label
         addCoef.col = "black",# tampilkan nilai korelasi di dalam kotak
